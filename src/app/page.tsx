  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="py-32 bg-[#132238] relative overflow-hidden">
          <div className="absolute inset-0 bg-[url('/images/cat_336_excavator.png')] opacity-5 mix-blend-overlay bg-cover bg-fixed bg-center" />
          
          <div className="max-w-7xl mx-auto px-4 relative z-10">
            <div className="flex flex-col lg:flex-row gap-16 items-center mb-20">
              <div className="lg:w-1/2">
                <AnimatedStep>
                  <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-bold uppercase tracking-widest mb-6 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                    <ShieldCheck className="w-4 h-4" />
                    The Equiplink Advantage
                  </div>
                  <h2 className="text-4xl md:text-5xl lg:text-6xl font-black font-heading text-white leading-tight mb-6">
                    Partnering in Your <span className="text-amber-500">Project's Success</span>
                  </h2>
                  <p className="text-slate-300 text-lg leading-relaxed max-w-xl">
                    We don't just rent equipment. We provide end-to-end heavy machinery solutions built on unmatched reliability, proactive maintenance, and dedicated support across Liberia.
                  </p>
                </AnimatedStep>
              </div>
              <div className="lg:w-1/2 grid grid-cols-2 gap-4">
                ...
                <AnimatedStep delay={0.2}>
                  <div className="bg-[#1e3454]/50 backdrop-blur-md p-6 rounded-[2rem] border border-white/5 shadow-2xl flex flex-col justify-center items-center text-center hover:bg-[#1e3454] transition-colors h-full">
                    <div className="text-4xl font-black text-amber-500 mb-2">24/7</div>
                    <div className="text-sm font-bold text-slate-300 uppercase tracking-widest">Support</div>
                  </div>
                </AnimatedStep>
                <AnimatedStep delay={0.3}>
                  <div className="bg-[#1e3454]/50 backdrop-blur-md p-6 rounded-[2rem] border border-white/5 shadow-2xl flex flex-col justify-center items-center text-center hover:bg-[#1e3454] transition-colors h-full mt-8">
                    <div className="text-4xl font-black text-emerald-400 mb-2">100%</div>
                    <div className="text-sm font-bold text-slate-300 uppercase tracking-widest">Insured Fleet</div>
                  </div>
                </AnimatedStep>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { 
                  title: "24/7 On-Site Maintenance", 
                  icon: Wrench, 
                  desc: "Our rapid-response mobile mechanic units ensure your downtime is kept to absolute zero.",
                  color: "text-blue-400",
                  bg: "bg-blue-500/10",
                ...
                { 
                  ...
                  icon: ShieldCheck, 
                  desc: "Need a crew? We provide fully licensed, insured, and experienced operators for every machine.",
                ...
                { 
                  ...
                  icon: MapPin, 
                  desc: "Monitor your rented fleet's location and usage metrics via our advanced GPS dashboard.",
                ...
                { 
                  ...
                  icon: Truck, 
                  desc: "From Monrovia to the most remote mining sites, our lowbeds deliver exactly when you need it.",
                  color: "text-purple-400",
                  bg: "bg-purple-500/10",
                  border: "group-hover:border-purple-500/50"
                },
              ].map((feature, i) => (
                <AnimatedStep key={i} delay={i * 0.15}>
                  <div className={`group bg-[#1e3454]/30 backdrop-blur-sm p-8 rounded-[2rem] border border-white/5 shadow-xl hover:-translate-y-2 transition-all duration-300 h-full flex flex-col ${feature.border}`}>
