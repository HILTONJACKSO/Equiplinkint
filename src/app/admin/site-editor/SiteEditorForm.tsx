      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-y-auto">
        ...
        <header className="sticky top-0 z-10 bg-white/95 backdrop-blur border-b border-border px-4 md:px-8 h-16 flex items-center justify-between shrink-0">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-heading font-bold text-xl text-primary">Site Editor</h1>
              <p className="text-xs text-muted-foreground hidden sm:block">Manage your website's content</p>
            </div>
          </div>
        ...
        {/* Editor Forms */}
        <main className="flex-1 px-4 md:px-8 py-6 max-w-4xl space-y-8">
          
          <section className="bg-white rounded-2xl border border-border p-6 space-y-6">
            <div className="border-b border-border pb-4">
              <h2 className="text-lg font-bold text-primary">Hero Section</h2>
              <p className="text-sm text-muted-foreground">The main banner text on the homepage.</p>
            </div>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                <label className="text-sm font-semibold">Title Line 1</label>
                <Input 
              ...
              <div className="space-y-2">
                <label className="text-sm font-semibold">Title Line 2</label>
                <Input 
              ...
              <div className="space-y-2 md:col-span-2">
                <label className="text-sm font-semibold">Subtitle Text</label>
                <Textarea 
          ...
          <section className="bg-white rounded-2xl border border-border p-6 space-y-6">
            <div className="border-b border-border pb-4">
              <h2 className="text-lg font-bold text-primary">Header Configuration</h2>
              <p className="text-sm text-muted-foreground">Contact details displayed in the top navbar.</p>
            </div>
            <div className="space-y-2">
          ...
          <section className="bg-white rounded-2xl border border-border p-6 space-y-6">
            <div className="border-b border-border pb-4">
              <h2 className="text-lg font-bold text-primary">Footer Configuration</h2>
              <p className="text-sm text-muted-foreground">Bottom of the page information.</p>
            </div>
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2 md:col-span-2">
