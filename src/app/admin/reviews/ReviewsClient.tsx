      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        <header className="h-16 shrink-0 bg-white border-b border-slate-200 flex items-center justify-between px-4 sm:px-6 z-10 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <h1 className="text-lg font-semibold text-slate-900 tracking-tight">Reviews & Ratings</h1>
          </div>
                      ...
                      <tr>
                        <td colSpan={5} className="px-6 py-12 text-center text-slate-500">
                          <div className="flex flex-col items-center justify-center">
                            ...
                            <p className="text-base font-medium text-slate-900">No reviews found</p>
                            <p className="text-sm text-slate-500 mt-1">There are no reviews in the database yet.</p>
                          </div>
                        </td>
                      </tr>
                    ) : (
